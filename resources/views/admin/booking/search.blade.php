...
@section("content")
    ...
    <div class="container">
        <div class="row">
            <div class="col-9">
                <form action="/admin/booking/search" method="get">
                @csrf
                <input type="text" class="form-control" name="search" id="search" placeholder="請輸入醫生或會員帳號" aria-label="請輸入醫生或會員帳號" aria-describedby="button-addon2">
